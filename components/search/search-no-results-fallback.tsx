...
export function SearchNoResultsFallback({ query }: Props) {
  ...
  const suggestedCollections = useMemo(
    ...
    () => collections.filter((c) => c.slug !== "sale").slice(0, 6),
    ...
    <div className="mt-6 space-y-8 sm:mt-8">
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50/80 px-4 py-4 sm:px-5">
        ...
        <p className="mt-1 text-sm text-amber-900/90">
          ...
          Try a different spelling, browse a collection, or message us — we can help you find it.
      ...
      {suggestedCollections.length > 0 ? (
        ...
        <section aria-label="Suggested collections">
          ...
          <h2 className="text-base font-semibold text-neutral-900">Try a collection</h2>

          <p className="mt-1 text-sm text-neutral-600">Browse by category instead of search.</p>

          <ul className="mt-3 flex list-none flex-wrap gap-2">

            {suggestedCollections.map((c) => (
              ...
              <li key={c.slug}>
                ...
                <Link
                  ...
                  className="inline-flex items-center rounded-full border border-neutral-200 bg-white px-3.5 py-1.5 text-[13px] font-medium text-neutral-800 transition hover:border-neutral-400 hover:bg-neutral-50"
      ...
      <section aria-label="Popular products">
        ...
        {loadingPopular ? (
          ...
          <div className="mt-4 grid grid-cols-2 gap-1 sm:gap-1.5 md:grid-cols-3 md:gap-2 lg:grid-cols-5 lg:gap-2">
