-- PKR as default currency; flat delivery Rs 500 = 50_000 paisa (stored in *_cents columns as minor units).

update public.store_settings set default_currency = 'PKR' where id = 1;
...
comment on function public.place_order(jsonb) is
  'Checkout: PKR; amounts in *_cents columns are paisa (minor units). Flat delivery Rs 500.';
