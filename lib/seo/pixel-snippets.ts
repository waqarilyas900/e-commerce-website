/**
 * Inline script bodies for Meta / TikTok pixels. IDs are read from
 * `public.seo_analytics` via the layout. Values are embedded with
 * `JSON.stringify` so admin-entered IDs are safe inside generated JS.
 */

export function metaPixelInlineScript(pixelId: string): string {
